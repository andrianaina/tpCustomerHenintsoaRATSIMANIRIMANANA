 ...
 */
package mg.itu.tpcustomerhenintsoaratsimanirimanana.entities;
...
public class Customer implements Serializable {
    ...
    public String toString() {
        return "mg.itu.tpcustomerhenintsoaratsimanirimanana.entities.Customer[ customerId=" + customerId + " ]";
    }
